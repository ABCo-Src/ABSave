...
namespace ABSoftware.ABSave.Converters
{
    ...
    /// </summary>
    public interface IABSaveConverterContext { }

    public abstract class ABSaveConverter
    {
        /// <summary>
        ...
        /// </summary>
        public abstract IABSaveConverterContext TryGenerateContext(ABSaveMap map, Type type);

        public abstract void Serialize(object obj, Type actualType, IABSaveConverterContext context, ref BitTarget header);
        public abstract object Deserialize(Type actualType, IABSaveConverterContext context, ref BitSource header);

        internal static readonly IReadOnlyDictionary<Type, ABSaveConverter> BuiltInExact = new Dictionary<Type, ABSaveConverter>()
        {
        ...
        internal static IReadOnlyList<ABSaveConverter> BuiltInNonExact = new List<ABSaveConverter>()
        {
